...
export default function Navbar() {
    ...
    return (
        <nav
            className={`sticky top-0 z-50 relative transition-colors duration-300 ${isBgWhite ? 'bg-white shadow-sm' : 'bg-gradient-to-b from-black/60 via-black/30 to-transparent'
                }`}
        >
