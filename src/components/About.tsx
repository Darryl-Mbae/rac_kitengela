...
const About = () => {
  ...
  return (
    <div className="w-full ">
      <motion.div
        ref={ref}
        className="lg:py-[25vh] py-[15vh]  text-center text-3xl lg:text-5xl w-[80%] lg:w-[60%] mx-auto leading-tight"
      ...
      >
        ...
        <div className="font-light font-display">
          <span className="relative inline-block">
            ...
            <svg
              ...
              className="absolute -top-5 -left-4 w-8 h-10 scale-x-[-1] -rotate-80"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          driven by <span className="text-cranberry">service</span>, and{" "}
