...
function JoinUs({ }: Props) {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row h-auto lg:h-[550px] gap-4 my-10  lg:my-20 lg:mt-30">
      <div className='w-full lg:w-[32%] h-full'>
        <div className="mx-auto w-[90%] md:w-[85%] py-8 lg:py-10 flex flex-col relative">
          {/* content determines height */}
          <h1 className='pb-6 relative sm:text-5xl text-4xl lg:text-5xl font-display font-light'>
          ...
          <p className='text-sm leading-relaxed text-[#55697a]'>Friendship, Service, Growth. Rotaract is a network of passionate individuals committed to uplifting others while growing together. Join us as we serve, connect, and make a lasting difference.</p>

          <Link
            to="/join"
            className="mt-5 px-1 py-1 rounded-full text-sm flex w-[40%] md:w-[45%] items-center gap-3 transition-transform duration-200 hover:scale-105 bg-primary"
          >
            ...
            <span className="pr-6 text-white">Join Us</span>
          </Link>
      ...
      <div className='flex flex-col gap-8 w-full lg:w-[68%] h-full'>
        <div className='w-full h-full'>
          <div className="w-full h-150 lg:h-full">
            <div className="relative w-full h-full">
              ...
              >
                {/* Slide 1 */}
                <SwiperSlide className='h-44 lg:h-64 overflow-hidden rounded-xl'>
                  <div className="relative w-full h-full">
                    <div
                      onClick={handleNextSlide}>
                      <div className=" cursor-pointer absolute top-2 right-2 text-white h-10 w-10 rounded-full flex items-center justify-center bg-primary">
                        <GoArrowUpRight />
                      </div>
                    </div>
                    <img
                    ...
                    <div className="absolute bottom-0 left-0 right-0 flex items-end  text-white px-4 pb-4">
                      <div>
                        <h2 className="text-xl font-display">Create Meaningful Community Impact.</h2>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide className='w-full h-44 lg:h-64 flex flex-col gap-2'>
                  <div className="h-[18%] w-full bg-primary rounded-xl flex items-center  px-6 py-7 text-xl font-display mb-2">
                    <p className='text-white'>
                      Join a{" "}
                      <span className="font-cursive text-white text-2xl">
                        Supportive {" "}
                      </span>{"  "}
                      circle of like-minded change-makers
                    </p>
                  </div>
                  <div className='w-full relative h-[80%] overflow-hidden rounded-xl'>
                    <img
                      src="images/JOIN/join2.jpeg"
                      alt="Slide Image"
                      className="w-full h-full object-cover"
                    />
                    ...
                    {/* Text positioned at bottom */}
                    <div className="absolute bottom-0 left-0 right-0 flex items-end text-white px-4 pf-4">
                      <div>
                        <h2 className="text-xl font-display pb-3">Develop Your Leadership Potential and more</h2>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide className='h-44 lg:h-64 overflow-hidden rounded-xl'>
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 flex items-end  text-white px-4 pb-4">
                      <div>
                        <h2 className="text-xl font-display">Expand Your Professional Network.</h2>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide className='w-full h-44 lg:h-64 flex flex-col gap-2'>
                  ...
                  <div className="h-[18%] mt-2 w-full bg-primary rounded-xl flex items-center  px-6 py-7 text-2xl font-display mb-2">
                    <p className='text-white text-xl'>
                      Connect, grow, and {" "}
                      <span className="font-cursive text-cranberry text-2xl!">
                        {"  "} Create {"  "}
                      </span>{"  "}
                      lasting impact.
                    </p>
        ...
        <div className='md:hidden mt-3 flex flex-row items-center gap-1 justify-center'>
          <div className="swiper-prev text-white bg-primary h-8 w-8 rounded-full flex items-center justify-center cursor-pointer" onClick={handlePrevSlide}><HiMiniArrowDownLeft /></div>
          <div className="swiper-next bg-primary h-8 w-8 rounded-full flex items-center justify-center text-white cursor-pointer" onClick={handleNextSlide}><HiMiniArrowUpRight /></div>
        </div>
      </div>
