  ...
  return (
    <div id="executive" className='w-full overflow-hidden'>
      <div className='flex justify-between mt-10'>
        <h1 className='mx-auto relative pl-4 font-light mb-5 mt-1 font-display text-4xl leading-tight text-[#16222c]'>
        ...
        >
          {boardMembers.map((member, index) => (
            ...
            >
              ...
              <div className='w-full h-[30%] flex flex-col items-center justify-center gap-1 shrink-0 text-white'>
              ...
              <div className='w-full h-[70%] overflow-hidden'>
                <img
                  ...
                  src={`images/BOARD/${member.id}.png`}
                  alt={member.name}
                />
              </div>
            </SwiperSlide>
      ...
      <div className='mt-10 flex flex-row items-center gap-1 justify-center'>
