...
import { FaAsterisk, FaStar } from "react-icons/fa6";
...
function Hero() {
  ...
  return (
    <div className="relative w-[110%] ml-[-5%] min-h-screen flex flex-col items-center justify-center">
      <FaStar className=" absolute text-cranberry left-10 lg:left-70 top-100 lg:top-60 rotate-12 size-10" />
      <FaAsterisk className="absolute text-[#9fc032] right-22 lg:right-90 top-5 lg:top-20 rotate-12 size-10" />
      <img src="/images/svg2.png" alt="" className="hidden lg:flex -z-20 absolute left-[1%] top-24" />

      <div className='mt-20 font-semibold text-center text-primary text-5xl lg:text-5xl w-[95%] lg:w-[80%] mx-auto leading-tight'>
        ...
        <span className='relative inline-block'>
          ...
          <span className='absolute -bottom-6 left-0 '>
            <svg width="100%" height="38" viewBox="0 0 340 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-row items-center gap-2 my-6">
        <div className="gap-2 bg-secondary rounded-xl px-4 py-2 text-primary flex flex-row items-center justify-center">
          <p className="m-0! p-0!">Service</p> <span className="text-[#9fc032]"><FaAsterisk />
          </span>
        </div>
        <div className="hidden md:flex gap-2 bg-secondary rounded-xl px-4 py-2 text-primary flex-row items-center justify-center">
          <p className="m-0! p-0!">Leadership</p> <span className="text-[#9fc032]"><FaAsterisk />
          </span>
        </div>
        <div className="gap-2 bg-secondary rounded-xl px-4 py-2 text-primary flex flex-row items-center justify-center">
          <p className="m-0! p-0!">Community</p> <span className="text-[#9fc032]"><FaAsterisk />
          </span>
        </div>
      </div>
      ...
      <div className="w-full overflow-hidden mt-5 grid grid-cols-[15%_70%_15%] md:grid-cols-[15%_70%_15%] lg:grid-cols-[20%_60%_20%] h-[75vh] lg:h-[58vh] gap-2 lg:gap-5 items-center">
        ...
        <div className="w-[300%] -ml-[200%] h-[65%] lg:h-[80%] rounded-3xl overflow-hidden">
          <img
            src={galleryImages[10].src}
            alt={galleryImages[10].alt}
            className="m-auto w-full h-full object-cover -mr-[25%]"
          />
        </div>

        <div className="relative h-full w-full bg-transparent overflow-hidden flex items-center justify-center">
      ...
      "
        ...
        <div className="w-[300%] -mr-[200%] h-[65%] lg:h-[80%] rounded-3xl overflow-hidden">
          <img
            src={galleryImages[15].src}
            alt={galleryImages[10].alt}
            className="m-auto w-[65%] h-full object-cover object-left -ml-[15%]"
          />
        </div>
      </div>
    </div >
