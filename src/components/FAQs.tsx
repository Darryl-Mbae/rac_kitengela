...
function FAQs() {
    ...
    if (loading) {
        return (
            <div className="grid grid-cols-1 lg:grid-cols-2 bg-primary p-8 lg:p-10 rounded-2xl">
    ...
    return (
        <div className=" text-black grid grid-cols-1 lg:grid-cols-2  py-3 md:py-8 lg:py-10 rounded-2xl">
            <div className="px-4 flex flex-col justify-between gap-4 lg:gap-0">
                <div >

                    <div className="mb-5 inline-flex items-center rounded-full border border-white/15 bg-primary px-5 py-2 backdrop-blur-xl">
                        <div className="mr-3 h-2 w-2 rounded-full bg-[#F7C948]" />
                        <span className="text-xs uppercase text-white">
                            FAQs
                        </span>
                    </div>
                    <h1 className="lg:mt-10 font-display text-3xl lg:text-5xl lg:w-[60%] relative ">
                        Learn M
                        ...
                        >
                            ...
                            >
                                <div className="flex flex-row  lg:items-center gap-4">
                                    ...
                                    <span className="text-xl font-medium lg:text-primary">
                            ...
                            >
                                <div className="overflow-hidden">
                                    <div className="flex flex-col md:flex-row gap-8 items-start ">
                                        {/* Text Content */}
                                        <p className="flex flex-end font-light text-gray-600 leading-relaxed md:w-1/2">
                                            {faq.answer}
                                        </p>
