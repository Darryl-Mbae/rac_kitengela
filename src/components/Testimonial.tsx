...
function Testimonial({view}) {
  ...
  return (
    <section className={` ${view === "laptop" ? "hidden md:block" : "md:hidden"} py-8 md:py-16  mt-[3vh] md:mt-[5vh] lg:mt-[10vh]`}>
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8 md:mb-12 flex flex-col flex-start gap-3 items-center">
          <div className="flex items-center gap-2 mb-4 lg:mb-0">
            <div className="inline-flex items-center rounded-full border border-white/15 bg-primary px-5 py-2 backdrop-blur-xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-display  mb-4 relative text-center leading-tight">
        ...
        <div className='w-full grid grid-cols-1 lg:grid-cols-[15%_85%] gap-4'>
          <div className='w-full flex flex-row  items-center lg:items-start justify-center lg:justify-start gap-2 mb-4 lg:mb-0'>
            <div
              className='cursor-pointer bg-tertiary flex items-center justify-center rounded-full p-2 text-2xl lg:text-3xl bg-primary text-white'
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-[35%_65%] gap-3 h-[400px]'>
                    ...
                    <div className='h-full w-full'>
                      <div className='h-full grid grid-cols-1 lg:grid-cols-[60%_40%] gap-3'>
                        <div className='w-full h-full bg-primary rounded-3xl p-6 md:p-10 flex flex-col justify-end min-h-[250px]'>
                          <FaQuoteRight className='scale-x-[-1] text-3xl md:text-4xl text-white' />
                          <div className='font-display text-lg md:text-2xl py-4 md:py-6 text-white leading-tight'>{testimonial.content}</div>
                          <div className='text-white font-display'>- {testimonial.name}</div>
                        </div>
                        <div className='hidden lg:flex flex-col gap-2 w-full lg:w-[90%]'>
                          ...
                          {testimonial.linkedin &&
                            ...
                            <div className='w-full h-12 bg-slate-50 rounded-3xl flex items-center justify-between pl-4'>
                              <span className='text-sm lg:text-display'>
                                Connect with {testimonial.name.split(" ")[0]}
                              </span>
                              <div onClick={() => window.open(testimonial.linkedin, "_blank")} className='cursor-pointer mr-2 h-8 lg:h-9 aspect-square rounded-full bg-cranberry text-primary flex items-center justify-center'>
